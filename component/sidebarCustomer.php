                    ...
                    <div class="side-bar">
                        ...
                        <div class="menu">
                            <div class="content-menu" >
                                ...
                                <a href="./dashboardCustomerPage.php" style="font-weight:600">Dashboard</a>
                            </div>
                            <div class="content-menu " >
                                <i class="fa fa-user-circle" aria-hidden="true"></i>
                                <a href="./profileCustomerPage.php" style="font-weight:600">Profil Pengguna</a>
                            </div>
                            <div class="content-menu " >
                                <i class="fa fa-usd" aria-hidden="true"></i>
                                <a href="./getStartedPage.php" style="font-weight:600">Mulai Transaksi</a>
                            </div>
                            <div class="content-menu " >
                                <i class="fa fa-history" aria-hidden="true"></i>
                                <a href="./listRiwayatTransaksiCustomerPage.php" style="font-weight:600">Riwayat Transaksi</a>
                            </div>
                            <div class="content-menu " >
