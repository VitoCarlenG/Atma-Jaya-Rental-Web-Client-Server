                    ...
                    <div class="side-bar">
                        ...
                        <div class="menu">
                            <div class="content-menu" >
                                ...
                                <a href="./dashboardManagerPage.php" style="font-weight:600">Dashboard</a>
                            </div>
                            <div class="content-menu " >
                                <i class="fa fa-percent"></i>
                                <a href="./listPromoManagerPage.php" style="font-weight:600">Kelola Promo</a>
                            </div>
                            <div class="content-menu " >
                                <i class="fa fa-calendar" aria-hidden="true"></i>
                                <a href="./listJadwalPegawaiPage.php" style="font-weight:600">Kelola Jadwal Pegawai</a>
                            </div>
                            <div class="content-menu " >
