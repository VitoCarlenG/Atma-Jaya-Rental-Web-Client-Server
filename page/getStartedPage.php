        ...
        echo '
            ...
            <hr>
                <div class="d-grid gap-2">
                    <a href="./createTransaksiWithDriverPage.php" class="btn btn-primary btn-lg" role="button" aria-disabled="true">Penyewaan Mobil Dengan Driver</a>
                    <a href="./createTransaksiWithoutDriverPage.php" class="btn btn-danger btn-lg" role="button" aria-disabled="true">Penyewaan Mobil Tanpa Driver</a>
                </div>
                <br>
                <div class="d-grid gap-2">
